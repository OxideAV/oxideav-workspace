...
| **WMA** | 🟢 ~92% — vendor v2 decode 45–60 dB, 3 dB ABS_SCALE fix (per-channel gain 0.99–1.00), §2.1 policy across sample rates (32 kHz cells recovered); LSP-envelope family docs-gapped | 🟢 ~88% — vendor-wire encoder: full v2 ladder (26 cells), masking-aware election + M/S + noise substitution, reservoir-paced RC; lacks LSP (§3.1) + v1 stream |
