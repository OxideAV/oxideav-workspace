...
| **JPEG XL** | 🚧 ~68% — rounds 1-5 against ISO/IEC 18181-1:2024 final core (master @ e261bc16). **All 5 small lossless fixtures decode PIXEL-CORRECT** vs expected.png (PNG-decoder-backed byte-for-byte): pixel-1x1, gray-64x64, gradient-64x64-lossless, palette-32x32, grey_8x8_lossless. Coverage: C.2.1 + H.2 + H.3 + H.4.1+H.4.2 + H.6.4 inverse Palette + H.6.3 inverse RCT (6 modes × 6 perms) + H.6.2 inverse Squeeze + H.5 Self-correcting predictor (WpState). 211 tests. Round-5 fixed RFC 7932 §3.5 early-stop in read_complex_prefix (running Kraft sum mid-stream → trailing symbols implicit zero). Round-4 fixed 6 H.5/C.3.3 spec divergences. FDIS-2021 typo #5 fixed by 2024; typos #1-#4 retained. Decoder rounds 7-11 + encoder rounds 1-6 retired 2026-05-08 under fruits-of-poisonous-tree (`old` branch); v0.0.5/v0.0.6/v0.0.7 yanked. Lacks ICC E.4 / LfGroup-PassGroup / XYB / VarDCT | — RETIRED 2026-05-08, re-author after decoder forward progress |
