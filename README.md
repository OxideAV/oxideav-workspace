...
| **AVIF** | 🟢 ~99% — HEIF→AV1 decode with grid/iovl/iden PIXEL composition + grid-alpha + layered lsel/a1op + every derived-image geometry; fuzz-hardened derived graph; lacks tmap/sato pixel composition + H.273 fill conversion | ✅ ~97% — AVIF muxer + encode: grid (tile election), overlay/iden, alpha/depth aux, layered a1lx, `avis` sequences, HDR metadata; AV1 bitstream black-box |
