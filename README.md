...
| **VP8** | ✅ 100% — RFC 6386 key+inter decode, bit-exact vs vpx/ffmpeg on 10+ multi-frame fixtures + 0.1.13 public-surface lock + standalone-API & ffmpeg-oracle e2e (PSNR 42-61 dB bidirectional) | ✅ 100% — Phase-2 I+P + SPLITMV + GOLDEN/ALTREF + multi-partition + RefreshControls + LoopFilterDeltas + §11 intra picker + §13.4 token-prob fitter + real complexity-aware two-pass rate-control (Vp8Encoder/Vp8EncoderConfig/Vp8EncoderStats/LoopFilterMode + 28 DEFAULT_* knobs) |
