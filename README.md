...
| **JPEG 2000** | 🚧 r10 (post-2026-05-20 orphan) — T.800 main-header + SOT/SOD + typed COC/QCC/POC/RGN/PLT/PPT + JP2 box + §B.10 tier-2 packet-header + §B.2/§B.3/§B.5 TileGeometry + §B.5 typed `ResolutionLevel` (per-r corners) + `SubBand { HL, LH, HH }` (per-r-per-orientation corners per Eq. B-14 / Table B.1) + §B.6 precinct + §B.7 code-block partition (Eq B-16/17/18) + §B.7/§B.9 precinct→code-block enumeration (PacketGeometry bridge) + Annex C §C.3 tier-1 MQ arithmetic decoder (MqDecoder/INITDEC/DECODE/RENORMD/BYTEIN, Table C.2 Qe + Table D.7 contexts); lacks §B.12 progression / Annex D coding passes / wavelet / dequant / MCT | 🚧 scaffold |
