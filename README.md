...
| **JPEG XL** | 🚧 ~35% — round-1..3 baseline (signature + container, ANS entropy module, LfGlobal + GlobalModular tree-prelude) + round 1 against ISO/IEC 18181-1:2024 final core (commit 3ef741e): Annex C.2.1 + H.2 (ModularHeader) + H.3 (Table H.2 neighbours + Table H.3 predictors 0-5/7-13) + H.4.1 (MA-tree traversal + Table H.4 properties) + H.6/H.7 (TransformInfo + SqueezeParam parsing); pixel-1x1.jxl decodes pixel-correct; djxl black-box validation passing. FDIS-2021 typo #5 fixed by 2024 edition (workaround removed); typos #1-#4 retained. Decoder rounds 7-11 + encoder rounds 1-6 reset 2026-05-08 under fruits-of-poisonous-tree (`old` branch); v0.0.5/v0.0.6/v0.0.7 yanked. Lacks H.5 Self-correcting predictor, RCT/Palette/Squeeze inverse, multi-leaf MA-tree on grey_8x8, VarDCT, ICC profile | — RETIRED 2026-05-08, re-author after decoder forward progress |
