...
| **MIDI** (SMF) | ✅ ~99% — SMF 0/1/2 → PCM via 32-voice mixer + SF2/SFZ/DLS soundfonts + typed meta/sysex surface (incl. Device Control SysEx: Master Volume/Balance/Tuning + GPC) + GM2 reverb/chorus DSP send bus (CA-024 Schroeder reverb + delay-line chorus, CC91-95 effect-depth classifier); synth −20% wall bit-identical | ✅ ~95% — SMF writer + synthesis |
