...
| **MS-MPEG-4** (v1 / v2 / v3) | 🚧 Clean-room scaffold; G4/G5 pri_A+pri_B byte arrays wired; canonical-Huffman walker tree at file 0x3df40 still OPEN — r25 confirmed 3-tier byte layout (4096 + 4096 + 352 records of `(sym:u32, bl:u32)`) but bit-reader semantics need helper `0x1c219351` disassembly; real-content (testsrc DIV3) still 5.30 dB Y | — |
