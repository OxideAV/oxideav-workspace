...
| **AV1** | 🚧 ~80% — full §5.11.5 decode_block syntax-walker end-to-end: complete §5.11.18/22/23 mode-info layer + §5.11.25 read_ref_frames + §7.10 find_mv_stack (spatial) + §5.11.30/§5.11.33 compute_prediction dispatcher + **all 13 §7.11.2 intra prediction modes** (DC + V/H + PAETH + SMOOTH/SMOOTH_V/SMOOTH_H + 6 directional D-modes D45/D67/D113/D135/D157/D203) + §7.11.2.{7,9,10,11,12} intra-edge helpers + §5.11.34 residual outer dispatch + §5.11.36 transform_tree recursion + §5.11.39 coefficients reader + §5.11.46 palette + §5.11.49 cache + §7.13 inverse transform (DCT/ADST/WHT/IDTX/FLIPADST × sizes 4-64 × 16 PlaneTxType combos) + §7.12.{2,3} dequant + §5.11.47 transform_type + §7.5 get_scan dispatcher + §7.12.3 step-3 frame-buffer merge (per-plane CurrFrame[Y/Cb/Cr]) (935 tests); **decoder produces real sample output for all-intra frames**. Lacks §9.5.3 Quantizer_Matrix + §7.10.2.5/.6 temporal-MV scan + §7.9 inter prediction + §7.14 loop filter + CDEF + LR + film grain | 🚧 scaffold |
