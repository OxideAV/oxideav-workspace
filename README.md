...
| **MP1** | 🚧 clean-room rebuild underway (2026-05-24) — Layer I frame-header parse + frame sync + Layer I frame-length math + CRC-presence wiring (22 tests, ISO/IEC 11172-3 only); lacks audio-data decode + CRC verification | 🚧 not started (rebuild) |
...
| **MP3** | 🚧 clean-room rebuild underway (2026-05-24) — MPEG-1/2 frame-header parser + per-frame length + resyncing frame-walker (22 tests, ISO/IEC 11172-3/13818-3 only); lacks Layer III decode, encoder, MPEG-2.5 | 🚧 not started (rebuild) |
