...
| **GSM 06.10** | 🚧 ~91% — §6.3 Table-6.2/6.5/6.6/6.7 conformance-boundary suite + clean-room §5.3 RPE-LTP decode + §4.4 homing + §1.7 unpack + 06.12 §6.1 receive-side comfort-noise (DTX silence-descriptor synthesis) + §6.2/§6.3.3.1 SEQ06H homing-frame conformance harness + Table 6.5/6.7 boundary pins | 🚧 ~95% — full §5.2 encode + §1.7 packer + §4.3 encoder homing (Table 4.1a/b bit-exact pin) + 06.12 §5.1/§5.2 transmit DTX comfort-noise (N=4 unquantised LAR/xmax averaging → SID parameter encoding); lacks bulk SEQ01-05 conformance corpus (unstaged ETSI ZIP) + §5.2 SID bit-packing (GSM 05.03 unstaged) |
...
| **Indeo 2/4/5** | 🚧 ~5% — Indeo5 (IV50) decode bootstrap (LSB-first bitreader + file/GOP/frame/band/picture headers); Indeo 4/5 also run sandboxed via `oxideav-vfw` | — |
