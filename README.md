...
- **Infrastructure** — `oxideav-core` (primitives: Packet / Frame / Rational /
  Timestamp / PixelFormat (incl. 16-bit planar YUV, Yuva422P/444P, VideoFrame palette side-channel) / ExecutionContext + **DoS framework: `DecoderLimits`
