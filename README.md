...
| **JPEG XL** | 🚧 ~45% — rounds 1+2 against ISO/IEC 18181-1:2024 final core (master @ e5df4c9): Annex C.2.1 + H.2 + H.3 (Table H.2 neighbours + Table H.3 predictors 0-5/7-13) + H.4.1+H.4.2 (MA-tree traversal + Table H.4 properties) + H.6.4 inverse Palette + H.6.3 inverse RCT (6 type modes × 6 perms) + H.6.2 inverse Squeeze (horiz/vert) + H.5 full Self-correcting predictor (WpState). Plus upstream prerequisites: RFC 7932 §3.5 CLCL right-to-left = LSB-first (no bit-reversal), ImageMetadata tail over-read trim, lenient pu0. pixel-1x1.jxl decodes pixel-correct; djxl black-box validation passing. 191 tests. FDIS-2021 typo #5 fixed by 2024 edition; typos #1-#4 retained against Annex D listings. Decoder rounds 7-11 + encoder rounds 1-6 reset 2026-05-08 under fruits-of-poisonous-tree (`old` branch); v0.0.5/v0.0.6/v0.0.7 yanked. Blocked at GlobalModular complex-prefix bit alignment (1 bit off — gray-64x64 / gradient-64x64-lossless / palette-32x32 / grey_8x8 all gated on this single fix) | — RETIRED 2026-05-08, re-author after decoder forward progress |
