...
| Codec | Decode | Encode |
|-------|--------|--------|
| **MJPEG** | ✅ ~97% — baseline + progressive 4:2:0/4:2:2/4:4:4/grey + 12-bit YUV + SOF9 arithmetic + lossless SOF3 + RFC 2435 RTP/JPEG + §G.1.1 SOF2 4-component CMYK/YCCK + arith_decode fuzz + §3.1.7 restart-aligned packetization + 4-component lossless SOF3 P=8 (Adobe APP14 CMYK) decode + RGB24 baseline JPEG packed-RGB output + decode-free SOF/chroma/colour-hint inspector + typed JFIF APP0 view (T.871 §10.1: `JfifUnits` enum + density/thumbnail + DPI/DPCM conversion + `parse_jfif_app0` validator) + typed Adobe APP14 view (T.872 §6.5.3) | ✅ ~97% — baseline + progressive + lossless SOF3 grey/RGB + DRI/RSTn + Pt 0..15 + 4-component CMYK encoder + 4-component lossless SOF3 P=8 + SOF0 Gray8 single-component lossy + progressive SOF2 single-component grayscale (3 spectral-selection scans DC + AC-low + AC-high) + SOF0 RGB24 baseline (Adobe APP14 + 'R'/'G'/'B' IDs) |
