...
| **MP3** | ✅ ~100% — bit-exact decode + ID3v2/Xing seek + MPEG-2.5 framing | 🚧 ~96% — Layer III + Annex D psychoacoustic: Phase-2 bit-allocation loop closed + Model 1 Steps 1-2 + Step-4 tonal/non-tonal classifier; lacks Tables D.1 line→Bark bridge + Model 2 + intensity-stereo |
