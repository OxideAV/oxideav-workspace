...
| **AV1** | 🚧 ~93% — decoder essentially feature-complete (1237 tests) — §5.11.5 walker + §7.11 prediction (all 13 intra + 4 inter modes) + §5.11.34 residual + §7.13 IDCT + §7.12/§9.5.3 dequant + §7.10.2.5/.6 temporal MV + post-pipeline (§7.14 LF + §7.15 CDEF + §7.16 superres + §7.17 LR + §7.18.3 film grain) | 🚧 ~10% encoder — §5.5/§5.9 sequence+frame OBU + §5.11.1 tile_group_obu framing + IVF + §8.2 SymbolWriter + §5.11 per-block intra mode_info + **§5.11.39 coefficient encode end-to-end** (driver loop + txb_skip/eob/dc_sign/coeff_base{_eob}/coeff_br/golomb). First end-to-end IVF emit at r208. Lacks §5.11.4 partition + §5.11.36 transform_tree + §5.11.18 inter mode_info + rate-distortion |
