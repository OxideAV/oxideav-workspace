...
| **NSF** (NES) | 🚧 ~93% — full 6502 + IRQ/NMI + 5/5 2A03 APU + DMC DMA + six expansion chips + NSF v1/v2/NSFe + Dendy region + mixe per-device gain + plst/psfx playlist + region-aware noise + FDS modulation/envelope/sound-enable/$4090..=$4097 + r154 Namco 163 per-channel timer accumulators + r175 Sunsoft 5B 17-bit-LFSR noise + 32-step envelope (all ten §Shape rows) + counter≥period tone-flip + dual-disable mixer with envelope-DAC routing; VRC7 still 2-op pending #861 | — synthesis only |
