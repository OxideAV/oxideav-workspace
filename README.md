...
| **H.263** | 🚧 ~82% (post-2026-05-18 orphan) — §5.1-§5.4 baseline + §6 IDCT/MV/half-pel/INTER + Annex J §J.3 deblock + Annex I §I.2/§I.3 AIC + Annex D §D.2 UMV + Annex F §F.2 4-MV candidate + Table F.1 chroma snap + Annex F §F.3 OBMC + §5.1.4 PLUSPTYPE + Annex I §I.3 INTRA-coef VLC + Annex K §K.2 Slice-Structured header + r151 Annex F INTER4V driver wiring + r181 §I.3 absorbed-INTRADC INTRA-block parser (Table I.2 events at scan pos 0; CBP bit gates DC; 323 tests); lacks Annex K driver wiring + PB-frames + PLUSPTYPE-gated driver + AIC DC/AC prediction reconstruction | 🚧 scaffold |
