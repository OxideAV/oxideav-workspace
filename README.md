...
| **AV1** | 🚧 ~63% — OBU + uncompressed header + msac + §9.4 default-CDF + §8.3.2 ctx selectors + §5.11.4 decode_partition walker + §5.11.5 decode_block syntax-walker + §5.11.15 read_tx_size + §5.11.16 read_block_tx_size + §5.11.17 read_var_tx_size + §5.11.18 inter_frame_mode_info dispatcher + §5.11.22 intra_block_mode_info + §5.11.23 inter_block_mode_info prologue + §5.11.25 read_ref_frames + §5.11.46 palette_colors_{y,u,v} + §5.11.49 get_palette_cache (627 tests); lacks §7.10 find_mv_stack + §5.11.30 compute_prediction + §5.11.34 residual + intra/inter prediction + IDCT + loop filter + CDEF + LR + film grain | 🚧 scaffold |
