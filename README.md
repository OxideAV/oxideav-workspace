...
| **AC-4** (Dolby) | 🚧 ~98% — A-SPX + DRC + 60+ ETSI codebooks + 5_X/7_X ACPL_1/2/3 + cfg0/1/2/3 + LFE + SSF/SNF + SAP + Pseudocode 121 companding + IMS bitstream_version≥2 walker + 7_X SIMPLE/Cfg3Five inner 5-ch IMDCT + r181 Pseudocode-121 parser indexing fix; lacks ETSI fixture RMS audit, object/a-joc substreams | 🚧 IMS ~66% — v0/v2 TOC + mono SIMPLE/ASF + stereo SIMPLE 2× SCE split-MDCT + joint M/S CPE + 5.0/5.1/7.1 SIMPLE Cfg3Five + 5_X SIMPLE/ASPX_ACPL_1/2 + ASPX_ACPL_3 multichannel encoder + 7.0 SIMPLE/ASPX_ACPL_2 + 7.0/7.1 SIMPLE/ASPX_ACPL_1 + r125 7.0 SIMPLE/Cfg3Five + r132/r135/r139/r144 real per-band α+β for ASPX_ACPL_1/2 5.0/7.0/7.1 + r181 Table-52 aspx_data_2ch SIGNAL band-count fix closes encoder-side "alpha_q desync" (5.0 ASPX_ACPL_2 end-to-end recovers non-zero per-band alpha_q); lacks real β for ACPL_3, real ASPX envelope coding, ASPX_ACPL_1 residual-layer end-to-end alignment |
