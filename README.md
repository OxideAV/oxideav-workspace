...
| **AV1** | 🚧 ~93% — decoder essentially feature-complete (1329 tests) — §5.11.5 walker + §7.11 prediction (all 13 intra + 4 inter modes) + §5.11.34 residual + §7.13 IDCT + §7.12/§9.5.3 dequant + §7.10.2.5/.6 temporal MV + post-pipeline (§7.14 LF + §7.15 CDEF + §7.16 superres + §7.17 LR + §7.18.3 film grain) | 🚧 ~15% encoder — pixel-space YUV→IVF driver (16×16 mono intra) with DC_PRED + forward 4×4 DCT + forward WHT (§7.13.3 lossless arm) + forward quantize + §5.11.4 partition + §5.11.36 transform_tree + §5.11.39 coefficient encode end-to-end. **Arbitrary-input pixel-roundtrip lossless at base_q_idx=0**. Lacks chroma + forward DCT 8/16/32/64 + forward ADST/FLIPADST/IDTX + §5.11.18 inter mode_info + RD |
