...
| **AV1** | 🚧 ~72% — OBU + uncompressed header + msac + §9.4 default-CDF + §8.3.2 ctx selectors + §5.11.4 decode_partition walker + §5.11.5 decode_block syntax-walker + §5.11.15-18 tx-size + mode-info dispatcher + complete §5.11.22 intra mode-info + complete §5.11.23 inter mode-info cascade (find_mv_stack → assign_mv → motion_mode → interintra → compound_type → interpolation_filter) + §5.11.25 read_ref_frames + §7.10 find_mv_stack (spatial path) + §7.10.3/§7.10.4 has_overlappable_candidates + find_warp_samples + §5.11.30/§5.11.33 compute_prediction dispatcher + §7.11.2.5 DC_PRED leaf + §5.11.34 residual outer dispatch + §5.11.36 transform_tree recursion + §5.11.39 coefficients reader (all_zero / eob_pt_* / eob_extra / coeff_base_eob / coeff_base / coeff_br / dc_sign / sign_bit / golomb) + §5.11.46 palette_colors_{y,u,v} + §5.11.49 get_palette_cache (768 tests); lacks §7.6 IDCT + §5.11.40/41 transform_type + §7.5 get_scan + §7.13 dequant + §7.10.2.5/.6 temporal-MV scan + 12 non-DC intra modes + inter prediction + reconstruct + loop filter + CDEF + LR + film grain | 🚧 scaffold |
