...
| **VP8** | ✅ 100% — RFC 6386 key+inter decode, bit-exact vs vpx/ffmpeg on 10+ multi-frame fixtures | 🚧 ~93% — Phase-2 I+P + SPLITMV + GOLDEN/ALTREF + multi-partition + RefreshControls + LoopFilterDeltas + r164 §13.4 fitter composed with §9.4 deltas + r165 §11 intra-pick parallel-composed with §13.4 fitter on stream refresh path (549+ tests) |
