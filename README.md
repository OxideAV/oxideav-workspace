...
| **MPEG-1 video** | 🚧 ~62% — headers + macroblock walk + dct_coeff + dequantiser + P1180-conformant IDCT + quant-matrix state machines + §6.2.4 I-picture decode driver + §7.6 picture-level P/B motion-compensation reconstruction driver (forward/backward/bidirectional MC + skipped-MB → real pixels end-to-end); lacks field-picture MC + encoder | 🚧 ~5% — scaffold |
