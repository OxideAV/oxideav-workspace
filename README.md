...
| **WebP** (VP8 + VP8L) | ✅ 100% — RFC 9649 container + VP8L lossless + ALPH + animated + VP8-lossy via sibling crate + API-COMPAT-0.1.2 surface lock (29-test compile-only contract; 508 tests registry / 485 standalone) | ✅ 100% — VP8L lossless encoder (LZ77 + spatial/color-transform + color-cache + multi-meta-prefix + Shannon chooser) + r168 VP8-lossy encode wired through oxideav-vp8 0.2.1 (RIFF/WEBP wrap + From<Vp8Error> 1-to-1 adapter + 3-test lossy roundtrip) |
