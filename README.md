...
| **AV1** | 🚧 ~85% — full §5.11.5 decode_block syntax-walker end-to-end (intra + inter arms wired): complete §5.11.18/22/23 mode-info layer + §5.11.25 read_ref_frames + §7.10 find_mv_stack (spatial) + §5.11.30/§5.11.33 compute_prediction dispatcher + **all 13 §7.11.2 intra modes** + §7.11.2.{7,9,10,11,12} intra-edge helpers + **complete §7.11.3 inter MC sample-generation** (§7.11.3.4 translational 8-tap + §7.11.3.5-8 WARP + Warped_Filters/Div_Lut + §7.11.3.9-10 OBMC overlap-blend + §7.11.3.11-15 5 compound mechanisms wedge/diffwtd/intra-variant/mask-blend/distance-weights) + §5.11.34 residual outer dispatch + §5.11.36 transform_tree + §5.11.39 coefficients + §5.11.46 palette + §7.13 inverse transform (DCT/ADST/WHT/IDTX/FLIPADST × 4-64 × 16 PlaneTxType) + §7.12.{2,3} dequant + §5.11.47 transform_type + §7.5 get_scan + §7.12.3 step-3 frame-buffer merge + §190 InterFrameContext wire-up (1011 tests); **decoder produces real sample output for all-intra frames + all inter-pred kernels callable**. Lacks §7.11.3.1 inter MC driver wiring (kernels done; driver iterates per-block candidates) + §9.5.3 Quantizer_Matrix + §7.10.2.5/.6 temporal-MV scan + §7.14 loop filter + CDEF + LR + film grain | 🚧 scaffold |
