...
| **AV1** | 🚧 ~66% — OBU + uncompressed header + msac + §9.4 default-CDF + §8.3.2 ctx selectors + §5.11.4 decode_partition walker + §5.11.5 decode_block syntax-walker + §5.11.15-18 tx-size + mode-info dispatcher + §5.11.22 intra mode-info + §5.11.23 inter mode-info full cascade (YMode dispatch + drl_mode loops) + §5.11.25 read_ref_frames + §7.10 find_mv_stack (spatial path) + §5.11.30 get_mode + §5.11.31 assign_mv + §5.11.32 read_mv_component (mv_joint/class/class0 ladder + mv_bit loop + mv_fr + mv_hp) + §5.11.27 read_motion_mode + §7.10.3 has_overlappable_candidates + §7.10.4 find_warp_samples + §5.11.46 palette_colors_{y,u,v} + §5.11.49 get_palette_cache (691 tests); lacks §5.11.28 read_interintra_mode + §5.11.29 read_compound_type + §5.11.34 residual + §7.10.2.5/.6 temporal-MV scan + intra/inter prediction + IDCT + loop filter + CDEF + LR + film grain | 🚧 scaffold |
