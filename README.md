...
| **MP1 / MP2** | ✅ Layer I + Layer II decode to PCM with CRC-16 verify; lacks bit-exact PSNR + LSF (#1076) + Annex D psy | 🚧 ~25% — Layer I encoder + Layer II bit-allocation core + SNR ladder + Layer II header/CRC writers; lacks Layer II analysis filterbank + SCFSI + quantizer + Annex D psy |
