...
| **GSM 06.10** | 🚧 ~91% — clean-room §5.3 RPE-LTP decode + §4.4 homing + §1.7 unpack + 06.12 §6.1 receive-side comfort-noise (DTX silence-descriptor synthesis) + §6.2/§6.3.3.1 SEQ06H homing-frame conformance harness + Table 6.5/6.7 boundary pins | 🚧 ~95% — full §5.2 encode + §1.7 packer + §4.3 encoder homing (Table 4.1a/b bit-exact pin); lacks bulk SEQ01-05 conformance corpus (unstaged ETSI ZIP) + §5 transmit DTX/SID |
| **G.711** (μ/A-law) | ✅ 100% | ✅ 100% |
| **G.722** | 🚧 ~86% — SB-ADPCM decoder + QMF + auxiliary-data channel + clause-2 transmission-characteristics conformance masks + Recommendation pseudo-code conformance vectors | 🚧 ~82% — SB-ADPCM encoder (transmit-QMF normalisation spec-corrected) + Mode 2/3 round-trip + Appendix-II test-sequence harness |
