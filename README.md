...
| **MP2** | 🚧 r126 step 1 (post-2026-05-24 orphan) — §2.4.1.3 / §2.4.2.3 Layer II frame-header parser (full validation: bad sync, LSF, layer code, bitrate, sample-freq, emphasis, disallowed (bitrate, mode) matrix) + §2.4.3.1 frame sizing + Annex B Table 3-B.1 scalefactors; 21 tests; lacks audio-data decode + LSF tables + CRC + encoder | 🚧 scaffold |
