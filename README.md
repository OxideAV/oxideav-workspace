...
| **MP3** | ✅ ~100% — bit-exact decode + ID3v2/Xing seek + MPEG-2.5 framing | 🚧 ~97% — Layer III + Annex D psychoacoustic: Phase-2 bit-allocation loop closed + Model 1 Steps 1-7 end-to-end + Model 2 §D.2.3 spreading function + Tables D.3a-c/D.4a-c + §D.2.4 steps f)–n) (back half complete); lacks Model 2 FFT steps a)–e) + intensity-stereo |
