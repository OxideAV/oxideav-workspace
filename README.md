...
| **TIFF** (6.0) | ✅ ~98% — II/MM + BigTIFF + 7 photometrics + 1/4/8/16-bit + None/PackBits/LZW/Deflate/CCITT-MH/T.4-1D + tiles + multi-page + JPEG-in-TIFF (incl. CMYK) + PlanarConfiguration=2 + cargo-fuzz (7.7 M iter panic-free) + §SampleFormat (tag 339) + §Orientation (tag 274) decoder inspection | ✅ Gray8/16/RGB24/Palette8/CIELab/CMYK/YCbCr 4:4:4 (chunky) — None/PackBits/LZW/Deflate + Predictor=2 + PlanarConfiguration=2 + Bilevel CCITT-MH / T.4-1D + tiled chunky + tiled PlanarConfiguration=2 |
