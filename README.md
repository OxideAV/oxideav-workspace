...
| **MP3** | ✅ ~100% — bit-exact decode + ID3v2/Xing seek + MPEG-2.5 framing | 🚧 ~97% — Layer III + Annex D psychoacoustic: Phase-2 bit-allocation loop closed + Model 1 Steps 1-7 chain end-to-end (Tables D.1a-f transcribed + Step-4→Bark bridge + Step-5 sieve); lacks Model 2 + intensity-stereo |
