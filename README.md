...
| **AV1** | 🚧 ~93% — full §5.11.5 decode_block syntax-walker + **complete §7.11 prediction layer including §7.11.3.1 driver all 4 motion modes** (all 13 intra + SIMPLE / compound 5-type / WARPED_CAUSAL / OBMC) + §5.11.34 residual + §7.13 inverse transform + §7.12.{2,3} dequant + §9.5.3 Quantizer matrix + §7.10.2.5/.6 temporal-MV scan + **complete per-frame post-processing pipeline** (§7.14 deblock + §7.15 CDEF + §7.16 superres + §7.17 LR Wiener+SGR + §7.18.3 film grain) (1128 tests); decoder essentially feature-complete per documented spec gaps. Encoder pending | 🚧 scaffold |
