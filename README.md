...
| **VP8** | ✅ 100% | ✅ 100% |
| **VP9** | ✅ ~97% — 41/41 corpus byte-exact, tile-parallel decode; registry carries the full 12-format §7.2.2 matrix incl. 4:4:0 (core 0.1.35) | ✅ ~95% — alt-ref pyramid + show_existing_frame, all 4 SEG_LVL features, tile cols+rows, pixel-accurate scaled-ref, intra-only frames, Yuv440P input; lacks writer-side §8.4 adaptation, 2-pass RC |
