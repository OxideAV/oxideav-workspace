...
|-----------|:-----:|:---:|:----:|-------|
| WAV       | ✅ | ✅ | ✅ | Full metadata-chunk family (BWF bext, LIST/INFO, iXML, smpl/inst, Acidizer acid, ADM chna + BW64 axml/bxml/sxml XML carriers) + RF64/BW64 64-bit form (read + write; ds64/JUNK on-the-fly promotion) |
