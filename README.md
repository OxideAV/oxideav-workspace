...
| **MPEG-4 Part 2** | 🚧 ~74% — I/P/B texture + GMC + quarter-sample + full padding family + interlaced info + B-VOP MV bodies + §7.7.2.1 field-MV reconstruction + §7.6.2.2 quarter-sample field MC + §E.1.4.4 two-way RVLC Tcoef (forward + backward); lacks field-MV CASE 1/2/3 predictor + RVLC Strategy 1-4 arbitration + data-partitioning resync | 🚧 ~5% — scaffold |
...
| **QOI** | ✅ 100% | ✅ 100% |
| **TGA** | ✅ 100% | ✅ 100% |
| **ICER** (JPL) | 🚧 ~80% — bit-plane scan + spec-exact reversible integer wavelet (all 7 filters A–F+Q, IPN 42-155 §II.A, bit-exact lossless) + §III.B context model + packet-loss-lenient multi-segment decode | ✅ ~84% — quota encoding + R-D byte budget + PSNR-target rate control |
| **WBMP** | ✅ 100% | ✅ 100% |
