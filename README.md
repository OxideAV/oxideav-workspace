...
| **CELT** | 🚧 r8 (post-2026-05-20 orphan) — RFC 6716 §4.1 range decoder + §4.3 prefix + §4.3.2.1 coarse-energy scaffold + §4.3.2.2 fine-energy + finalize + §4.3.3 bit-allocation fields + §4.3.4.5 tf_change/tf_select + §4.3.4.3 spreading (PDF {7,2,21,2}/32 + Table 59 f_r + rotation-gain helpers); 112 tests; blocked on docs #936 (Laplace) + #943 (cache_caps50 / LOG2_FRAC_TABLE / alloc loop) | 🚧 scaffold |
