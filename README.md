...
| **MP3** | 🚧 clean-room rebuild underway (2026-05-24) — MPEG-1/2 frame-header parser + per-frame length + resyncing frame-walker + MPEG-1 Layer III side-info parser (§2.4.1.7; typed `SideInfo`/`GranuleChannel`, mono+stereo, long & window-switching; 32 tests, ISO/IEC 11172-3/13818-3 only); lacks main-data Huffman/requantize/IMDCT, MPEG-2 single-granule side-info, encoder, MPEG-2.5 | 🚧 not started (rebuild) |
