...
| **NSF** (NES) | 🚧 ~80% — full 6502 (incl. unofficial opcodes) + 5/5 APU channels + DMC DMA + six expansion chips (VRC6/MMC5/S5B/N163/VRC7-coarse/FDS); lacks NSF 2.x extra-features, cycle-accurate timing, VRC7 OPLL operator chain — round-74 docs-blocked pending nesdev wiki mirror (#858) | — synthesis only |
