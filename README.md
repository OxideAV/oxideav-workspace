...
| **G.723.1** | ✅ 100% | ✅ ~95% — both 5.3k + 6.3k, ITU-vector-verified wire (2816/2816 frames byte-identical repack; error frames rejected) + §3.6 excitation-domain pitch postfilter + OVERD53 corr +0.973 + Q15/Q31 saturating fixed-point decode pipeline (3 vector-arbitrated derivations; INEQD53 corr −0.01→0.83, floors pinned on all 6 vectors); bit-exact OVER/TAME needs the clause-5 overflow protocol (trace ask filed) | ✅ ~90% — §2.3 HPF + self-valid clause-4 streams on ITU inputs |
