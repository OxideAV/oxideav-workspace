...
| **JPEG XL** | 🚧 ~75% — rounds 1-7 against ISO/IEC 18181-1:2024 final core (master @ 8281e1e). **All 5 small lossless fixtures decode PIXEL-CORRECT** vs expected.png: pixel-1x1, gray-64x64, gradient-64x64-lossless, palette-32x32, grey_8x8_lossless. Coverage: C.2.1 + H.2 + H.3 + H.4.1+H.4.2 + H.6.4 inverse Palette + H.6.3 inverse RCT (6 modes × 6 perms) + H.6.2 inverse Squeeze + H.5 Self-correcting predictor (WpState). **Round 6 added Annex E.4 ICC profile decoder** (992 LOC, 41-context entropy stream + 14 unit tests, "acsp" magic verified). **Round 7 landed the four-piece multi-group refactor**: GlobalModular partial decode per G.1.3 + stream_index threading per H.4 + TOC layout addressing (zero-size entries OK) + post-PassGroup transform application; synthetic 320×320 multi-group fixture committed (num_groups=9 at group_dim=128). Multi-group decode blocked at NEW C.2.5 SPECGAP: cjxl 0.11.1 emits ANS alphabet_size=33 against table_size=32 (log_alphabet_size=5); spec + reference-encoder behaviour disagree (round-8 docs work). 245 tests. FDIS-2021 typo #5 fixed by 2024; typos #1-#4 retained. Decoder rounds 7-11 + encoder rounds 1-6 retired 2026-05-08 under fruits-of-poisonous-tree (`old` branch); v0.0.5/v0.0.6/v0.0.7 yanked. Lacks XYB / VarDCT | — RETIRED 2026-05-08, re-author after decoder forward progress |
