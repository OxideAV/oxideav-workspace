...
| **MP1** | 🚧 scaffold (orphan rebuild post-audit 2026-05-24) | 🚧 scaffold — register-only stub; prior decode+encode erased (synthesis-window table had external-library provenance); clean-room re-build pending vs ISO/IEC 11172-3 Layer I |
...
| **MP3** | 🚧 scaffold (orphan rebuild post-audit 2026-05-24) | 🚧 scaffold — register-only stub; prior decode+encode erased (data tables / decode-loop structures had external-reference provenance per NOTICES.md); clean-room re-build pending vs ISO/IEC 11172-3 / 13818-3 Layer III |
