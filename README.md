...
| **OBJ** (+ MTL) | ✅ ~98% — full Wavefront grammar + MTL (Phong + PBR) + free-form curves/surfaces with trim-loop re-meshing + ctech cparm resolution-aware tessellation + typed directive accessors + fuzz | ✅ ~96% — symmetric + negative-index encoder |
