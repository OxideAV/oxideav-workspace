...
| **MP3** | ✅ ~100% — bit-exact decode + ID3v2/Xing seek + MPEG-2.5 framing | 🚧 ~97% — Layer III + Annex D psychoacoustic: Phase-2 bit-allocation loop closed + Model 1 Steps 1-7 end-to-end + Model 2 §D.2.3 spreading function + steps f/g; lacks Model 2 remainder (Tables D.3/D.4) + intensity-stereo |
